...
## Let's Try to Use the San Francisco Data to get some insights.
...
The graph below demonstrates the temperature categorizing from the hottest to the coldest in months. It is based on the last 150 plus years.
```{r}
...
The graph shows the declining temperature for the last 150 years plus.
```{r}
...
In this section, the graph demostrates the distribution on the temperature uncertainty for the last 100 years in SF.
```{r}
